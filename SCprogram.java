...
class App extends Thread{
	public void run (){
		...
		Globals.listBackgrounds.costumes.add(new Costume("backdrop1",8,"510da64cf172d53750dffd23fbf73563.png",1,240,180,);
		Globals.listBackgrounds.costumes.add(new Costume("underwater3",9,"be203c37c3ea07b39a5519d1a55214ff.gif",1,240,180,);
		Globals.listBackgrounds.costumes.add(new Costume("backdrop2",10,"f3912a1e36ffa0f64d22349466ba95dc.svg",1,243,182,481,360));
		Globals.cucumberKey = false;
